...
module top_darjeeling_no_ibex #(
  ...
  output logic       no_ibex_msip_o,
  output logic       no_ibex_irq_o,
  ...
  import top_pkg::*;
  import tl_main_pkg::*;
  import top_darjeeling_no_ibex_pkg::*;
  // Compile-time random constants
  import top_darjeeling_no_ibex_rnd_cnst_pkg::*;
  import top_darjeeling_no_ibex_racl_pkg::*;
  ...
  // of top_darjeeling_no_ibex's boundary.
  ...
  // secure_lc_io_div4_0
  assign lpg_cg_en[3] = clkmgr_aon_cg_en.io_div4_secure;
  assign lpg_rst_en[3] = rstmgr_aon_rst_en.lc_io_div4[rstmgr_pkg::Domain0Sel];
  // peri_spi_host0_0
  assign lpg_cg_en[4] = clkmgr_aon_cg_en.io_div4_peri;
  assign lpg_rst_en[4] = rstmgr_aon_rst_en.spi_host0[rstmgr_pkg::Domain0Sel];
  // powerup_por_io_div4_Aon
  assign lpg_cg_en[5] = clkmgr_aon_cg_en.io_div4_powerup;
  assign lpg_rst_en[5] = rstmgr_aon_rst_en.por_io_div4[rstmgr_pkg::DomainAonSel];
...
// pragma coverage off
    ...
    assign unused_rst_en_25 = rstmgr_aon_rst_en.spi_host0[rstmgr_pkg::DomainAonSel];
    prim_mubi_pkg::mubi4_t unused_rst_en_26;
    assign unused_rst_en_26 = rstmgr_aon_rst_en.i2c0[rstmgr_pkg::DomainAonSel];
//VCS coverage on
// pragma coverage on
  ...
  otp_ctrl #(
    .AlertAsyncOn(alert_handler_reg_pkg::AsyncOn[8:4]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    ...
    .RndCnstScrmblKeyInit(RndCnstOtpCtrlScrmblKeyInit)
      ...
      // [7]: fatal_prim_otp_alert
      // [8]: recov_prim_otp_alert
      .alert_tx_o  ( alert_tx[8:4] ),
  ...
  lc_ctrl #(
    .AlertAsyncOn(alert_handler_reg_pkg::AsyncOn[11:9]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles),
    ...
    .EscPingCountWidth(AlertHandlerEscPingCountWidth)
      ...
      .jtag_o(),
      .esc_scrap_state0_tx_i(alert_handler_esc_tx[0]),
      .esc_scrap_state0_rx_o(alert_handler_esc_rx[0]),
      .esc_scrap_state1_tx_i(alert_handler_esc_tx[1]),
      .esc_scrap_state1_rx_o(alert_handler_esc_rx[1]),
  ...
  soc_proxy #(
    .AlertAsyncOn(alert_handler_reg_pkg::AsyncOn[48:20]),
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
  ) u_soc_proxy (
      ...
      // [20]: fatal_alert_intg
      // [21]: fatal_alert_external_0
      // [22]: fatal_alert_external_1
      // [23]: fatal_alert_external_2
      // [24]: fatal_alert_external_3
      // [25]: fatal_alert_external_4
      // [26]: fatal_alert_external_5
      // [27]: fatal_alert_external_6
      // [28]: fatal_alert_external_7
      // [29]: fatal_alert_external_8
      // [30]: fatal_alert_external_9
      // [31]: fatal_alert_external_10
      // [32]: fatal_alert_external_11
      // [33]: fatal_alert_external_12
      // [34]: fatal_alert_external_13
      // [35]: fatal_alert_external_14
      // [36]: fatal_alert_external_15
      // [37]: fatal_alert_external_16
      // [38]: fatal_alert_external_17
      // [39]: fatal_alert_external_18
      // [40]: fatal_alert_external_19
      // [41]: fatal_alert_external_20
      // [42]: fatal_alert_external_21
      // [43]: fatal_alert_external_22
      // [44]: fatal_alert_external_23
      // [45]: recov_alert_external_0
      // [46]: recov_alert_external_1
      // [47]: recov_alert_external_2
      // [48]: recov_alert_external_3
      .alert_tx_o  ( alert_tx[48:20] ),
      .alert_rx_i  ( alert_rx[48:20] ),
  ...
  sram_ctrl #(
    ...
    .EccCorrection(SramCtrlMainEccCorrection)
      ...
      .racl_error_o(),
      .sram_rerror_o(),
      .regs_tl_i(tlul_pkg::TL_H2D_DEFAULT),
      .regs_tl_o(),
  ...
  mbx #(
    ...
    .AlertSkewCycles(top_pkg::AlertSkewCycles)
      ...
      .core_tl_d_i(tlul_pkg::TL_H2D_DEFAULT),
      .core_tl_d_o(),
  ...
  assign intr_vector = {
      intr_ac_range_check_deny_cnt_reached, // IDs [162 +: 1]
      intr_racl_ctrl_racl_error, // IDs [161 +: 1]
      ...
      intr_dma_dma_error, // IDs [130 +: 1]
      intr_dma_dma_chunk_done, // IDs [129 +: 1]
      intr_dma_dma_done, // IDs [128 +: 1]
      intr_edn1_edn_fatal_err, // IDs [127 +: 1]
      intr_edn1_edn_cmd_req_done, // IDs [126 +: 1]
      intr_edn0_edn_fatal_err, // IDs [125 +: 1]
      intr_edn0_edn_cmd_req_done, // IDs [124 +: 1]
      intr_entropy_src_es_fatal_err, // IDs [123 +: 1]
      intr_entropy_src_es_observe_fifo_ready, // IDs [122 +: 1]
      intr_entropy_src_es_health_test_failed, // IDs [121 +: 1]
      intr_entropy_src_es_entropy_valid, // IDs [120 +: 1]
      intr_csrng_cs_fatal_err, // IDs [119 +: 1]
      intr_csrng_cs_hw_inst_exc, // IDs [118 +: 1]
      intr_csrng_cs_entropy_req, // IDs [117 +: 1]
      intr_csrng_cs_cmd_req_done, // IDs [116 +: 1]
      intr_keymgr_dpe_op_done, // IDs [115 +: 1]
      intr_otbn_done, // IDs [114 +: 1]
      intr_kmac_kmac_err, // IDs [113 +: 1]
      intr_kmac_fifo_empty, // IDs [112 +: 1]
      intr_kmac_kmac_done, // IDs [111 +: 1]
      intr_hmac_hmac_err, // IDs [110 +: 1]
      intr_hmac_fifo_empty, // IDs [109 +: 1]
      intr_hmac_hmac_done, // IDs [108 +: 1]
      intr_soc_proxy_external, // IDs [76 +: 32]
      intr_aon_timer_aon_wdog_timer_bark, // IDs [75 +: 1]
      intr_aon_timer_aon_wkup_timer_expired, // IDs [74 +: 1]
      intr_pwrmgr_aon_wakeup, // IDs [73 +: 1]
      intr_spi_host0_spi_event, // IDs [72 +: 1]
      intr_spi_host0_error, // IDs [71 +: 1]
      intr_alert_handler_classd, // IDs [70 +: 1]
      intr_alert_handler_classc, // IDs [69 +: 1]
      intr_alert_handler_classb, // IDs [68 +: 1]
      intr_alert_handler_classa, // IDs [67 +: 1]
      intr_otp_ctrl_otp_error, // IDs [66 +: 1]
      intr_otp_ctrl_otp_operation_done, // IDs [65 +: 1]
